...
export default function AdminDashboard() {
  ...
  // Database of detailed responses
  const mockSubmissionDetails = {
    101: {
      id: 101,
      name: 'Arun Kumar',
      email: 'arun.k@mcc.edu.in',
      form: 'Innovation Grant Application',
      date: '2026-07-08 15:42',
      answers: [
        { q: 'Principal Investigator Name', a: 'Arun Kumar' },
        { q: 'Department / Institution', a: 'Computer Science' },
        { q: 'Project Title', a: 'AI-Powered Agricultural Drone for Precision Spraying' },
    ...
    102: {
      id: 102,
      name: 'Priya Sharma',
      email: 'priya.s@mcc.edu.in',
      form: 'Student Course Feedback',
      date: '2026-07-08 15:28',
      answers: [
        { q: 'Student Name', a: 'Priya Sharma' },
        { q: 'Course Title', a: 'Advanced Data Structures & Algorithms' },
        { q: 'Instructor', a: 'Dr. Jane Cooper' },
    ...
    103: {
      id: 103,
      name: 'Devadas K.',
      email: 'devadas.k@mcc.edu.in',
      form: 'Faculty Research Proposal',
    ...
    104: {
      id: 104,
      name: 'Mercy George',
      email: 'mercy.g@mcc.edu.in',
      form: 'Innovation Grant Application',
      date: '2026-07-08 12:30',
      answers: [
        { q: 'Principal Investigator Name', a: 'Mercy George' },
        { q: 'Department / Institution', a: 'Biotechnology' },
        { q: 'Project Title', a: 'Biodegradable Plastic Alternatives from Marine Algae' },
  ...
  // Database of aggregate form statistics
  const mockFormSummaries = {
    1: {
      title: 'Innovation Grant Application',
      total: 42,
      breakdown: [
        { label: 'Computer Science', count: 18, pct: '43%' },
        { label: 'Biotechnology', count: 12, pct: '28%' },
        { label: 'Physics', count: 8, pct: '19%' },
        { label: 'Chemistry', count: 4, pct: '10%' }
      ],
      recent: [
        { name: 'Arun Kumar', date: 'Today, 3:42 PM', status: 'Pending Review' },
        { name: 'Mercy George', date: 'Today, 12:30 PM', status: 'Approved' }
      ]
    },
    2: {
      ...
      total: 128,
      breakdown: [
        { label: 'Rating: 5 Stars (Excellent)', count: 74, pct: '58%' },
        { label: 'Rating: 4 Stars (Good)', count: 38, pct: '30%' },
        { label: 'Rating: 3 Stars (Average)', count: 12, pct: '9%' },
        { label: 'Rating: 2 Stars or below', count: 4, pct: '3%' }
      ],
      recent: [
        { name: 'Priya Sharma', date: 'Today, 3:28 PM', status: 'Completed' },
        { name: 'Sanjay Dutt', date: 'Today, 10:45 AM', status: 'Completed' }
      ]
    },
    3: {
      title: 'MCC Alumni Survey 2026',
      total: 0,
      breakdown: [],
      recent: []
    },
    4: {
      ...
      total: 89,
      breakdown: [
        { label: 'Faculty Senders', count: 35, pct: '39%' },
        { label: 'Postgraduate Students', count: 30, pct: '34%' },
        { label: 'Undergraduate Students', count: 24, pct: '27%' }
      ],
      recent: [
        { name: 'Dr. Ramesh K.', date: '2026-05-24', status: 'Completed' }
      ]
    },
    5: {
      title: 'Faculty Research Proposal',
      total: 15,
      breakdown: [
        { label: 'Physics Department', count: 6, pct: '40%' },
        { label: 'Chemistry Department', count: 5, pct: '33%' },
        { label: 'English Department', count: 4, pct: '27%' }
      ],
      recent: [
        { name: 'Devadas K.', date: 'Today, 2:15 PM', status: 'Pending Review' }
      ]
    }
  };
      ...
      <div className="admin-db-layout anim-fade-in" style={{ display: 'flex', minHeight: '100vh', background: '#f8fafc' }}>
        ...
        <aside className="db-sidebar" style={{ width: '280px', background: 'white', borderRight: '1px solid #e2e8f0', padding: '24px', display: 'flex', flexDirection: 'column', flexShrink: 0 }}>
          <div className="db-sidebar-header" style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '32px' }}>
            <img src="/mcc-mrf-logo.png" alt="MCC Logo" style={{ height: '40px', width: '40px', objectFit: 'contain' }} />
            <div>
    ...
    <div className="admin-layout">
      ...
      <aside className="admin-sidebar">
        <div className="admin-sidebar-header">
          <img src="/mcc-mrf-logo.png" alt="MCC Logo" className="admin-logo" />
